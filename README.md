...
jobs:
  minimal:
    ...
    steps:
      - uses: step-security/nix-quick-install-action@v35
...
```
$ nix build github:step-security/nix-quick-install-action#nix-2_26_1
...
```
$ nix shell github:step-security/nix-quick-install-action#nix-2_26_1 -c nix --version
nix (Nix) 2.26.1
```
...
```
$ nix flake show --quiet --all-systems github:step-security/nix-quick-install-action/v35
github:step-security/nix-quick-install-action/9f63be77f412a248c9d9a65a4c82cf066cdf8f0c?narHash=sha256-LvhUCCXf9rnJnjEEJyKMyh2oza3wPpndF9TVslKtGeU%3D
├───apps
│   ├───aarch64-darwin
...
└───packages
    ├───aarch64-darwin
    │   ├───nix-2_28_7: package 'nix-2.28.7'
    │   ├───nix-2_29_4: package 'nix-2.29.4'
    │   ├───nix-2_30_5: package 'nix-2.30.5'
    │   ├───nix-2_31_5: package 'nix-2.31.5'
    │   ├───nix-2_32_8: package 'nix-2.32.8'
    │   ├───nix-2_33_6: package 'nix-2.33.6'
    │   ├───nix-2_34_7: package 'nix-2.34.7'
...
```
$ nix build github:step-security/nix-quick-install-action/v29#nix-2_24_9
```
